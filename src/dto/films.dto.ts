...
export type FilmCreateDTO = z.infer<typeof FilmCreateDTO>; // extract the inferred type
export type LocalUserCreateDTO = z.infer<typeof UserCreateDTO>;
export type LocalUserLoginDTO = z.infer<typeof UserLoginDTO>;
